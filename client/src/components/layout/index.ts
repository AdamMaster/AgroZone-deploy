...
export { WelcomeBanner } from './welcome-banner/welcome-banner'
...
export { NotFoundContent } from './not-found/not-found-content'
export { JsonLd } from './json-ld'
export { YandexMetrika } from './analytics/yandex-metrika'
export { RegistrationGoalHandler } from './analytics/registration-goal-handler'
