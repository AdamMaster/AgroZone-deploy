...
export function SimilarAdsSection({ ads }: SimilarAdsSectionProps) {
  return (
    <div>
      ...
      <div className='flex snap-x snap-mandatory [scrollbar-width:none] gap-x-1 overflow-x-auto overscroll-x-contain pb-1 sm:gap-4 md:gap-y-4 xl:grid-cols-4 xl:gap-x-6 [&::-webkit-scrollbar]:hidden'>
        {ads.map(ad => (
